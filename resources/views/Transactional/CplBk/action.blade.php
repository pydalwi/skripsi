        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group required row mb-2">
                    <label for="group_code" class="col-sm-2 control-label col-form-label">Bahan Kajian</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="bk_id" name="bk_id" value="{{ isset($data->bk_id) ? $data->bk_id : '' }}" />
                        <small class="form-text text-muted">Bahan Kajian</small>
                    </div>
                </div>
