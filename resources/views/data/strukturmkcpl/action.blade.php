        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group required row mb-2">
                    <label for="group_name" class="col-sm-2 control-label col-form-label">CPL</label>
                    <div class="col-sm-10">
                        ...
                        <small class="form-text text-muted">CPL</small>
                    </div>
                </div>
                
                <div class="form-group required row mb-2">
                    <label for="group_code" class="col-sm-2 control-label col-form-label">Mata Kuliah</label>
                    <div class="col-sm-10">
