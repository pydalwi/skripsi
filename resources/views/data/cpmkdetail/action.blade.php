    ...
    <div id="modal-data" class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group required row mb-2">
                    <label class="col-sm-3 control-label col-form-label">Sub CPMK Kode</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group required row mb-2">
                    <label class="col-sm-3 control-label col-form-label">Uraian Sub CPMK</label>
                    <div class="col-sm-9">
                        <textarea rows="10" cols="30" type="text" class="form-control form-control-sm" id="uraian_sub_cpmk" placeholder="Uraian Sub CPMK" name="uraian_sub_cpmk">{{ isset($data->uraian_sub_cpmk) ? $data->uraian_sub_cpmk : '' }}</textarea>
                    </div>
                </div>
            </div>
            <div class="form-group required row mb-2">
