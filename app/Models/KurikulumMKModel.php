...
class KurikulumMKModel extends Model
{
    use SoftDeletes;
    ...
    public static function getMks()
{
    ...
    $map = DB::table('d_kurikulum_mk AS dk')
...
public static function getMksId($kurikulum_id)
{
    $map = DB::table('d_kurikulum_mk AS m')
        ->selectRaw('m.kurikulum_mk_id, k.mk_nama')
        ->join('m_mk AS k', 'm.mk_id', '=', 'k.mk_id')
        ->leftJoin('d_kurikulum AS d', 'm.kurikulum_mk_id', '=', 'd.kurikulum_mk_id')
        ->groupBy('m.kurikulum_mk_id', 'k.mk_nama')
        ->where('d.kurikulum_id', $kurikulum_id)
        ->get();
...
public static function getMksWithSelected($selectedId)
{
    return DB::table('d_kurikulum_mk AS m')
        ...
        ->join('m_mk AS k', 'm.mk_id', '=', 'k.mk_id')
        ->leftJoin('m_rps AS r', 'm.kurikulum_mk_id', '=', 'd.kurikulum_mk_id')
        ->groupBy('m.kurikulum_mk_id', 'k.mk_nama')
        ->get()
