...
class CplCpmkController extends Controller
{
    public function __construct(){
        $this->menuCode  = 'TRANSACTION.CPLCPMK';
        $this->menuUrl   = url('transaction/cplcpmk');     // set URL untuk menu ini
        $this->menuTitle = 'CPL-CPMK';                       // set nama menu
        $this->viewPath  = 'Transactional.CplCpmk.';         // untuk menunjukkan direktori view. Diakhiri dengan tanda titik
    }
    ...
    public function index(){
        ...
        $breadcrumb = [
            ...
            'list'  => ['Data Transaction', 'CPL-CPMK']
        ];

        $activeMenu = [
            'l1' => 'transaction',
            'l2' => 'transaction-cpl-cpmk',
            'l3' => null
        ];
