...
use App\Models\Transactional\RumusanakhircplModel;
use Yajra\DataTables\Facades\DataTables;
use Illuminate\Support\Facades\Validator;
class RumusanakhircplController extends Controller
{
    public function __construct(){
        $this->menuCode  = 'TRANSACTION.RUMUSANAKHIRCPL';
        $this->menuUrl   = url('transaction/rumusanakhircpl');     // set URL untuk menu ini
        $this->menuTitle = 'Rumusan Akhir CPL';                       // set nama menu
        $this->viewPath  = 'Transactional.Rumusanakhircpl.';         // untuk menunjukkan direktori view. Diakhiri dengan tanda titik
    }
    ...
    public function index(){
        ...
        $breadcrumb = [
            ...
            'list'  => ['Data Transaction', 'Rumusan Akhir CPL']
        ];

        $activeMenu = [
            'l1' => 'transaction',
            'l2' => 'transaction-rumusan-akhir-cpl',
            'l3' => null
        ];
