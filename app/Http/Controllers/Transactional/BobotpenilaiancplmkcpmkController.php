...
use App\Models\Transactional\BobotpenilaiancplmkcpmkModel;
use Yajra\DataTables\Facades\DataTables;
use Illuminate\Support\Facades\Validator;
class BobotpenilaiancplmkcpmkController extends Controller
{
    public function __construct(){
        $this->menuCode  = 'TRANSACTION.BOBOTPENILAIANCPL';
        $this->menuUrl   = url('transaction/bobotpenilaicpl');     // set URL untuk menu ini
        $this->menuTitle = 'Bobot Penilaian CPL-MK-CPMK';                       // set nama menu
        $this->viewPath  = 'Transactional.Bobotpenilaiancplmkcpmk.';         // untuk menunjukkan direktori view. Diakhiri dengan tanda titik
    }
    ...
    public function index(){
        ...
        $breadcrumb = [
            ...
            'list'  => ['Data Transaction', 'Bobot Penilaian CPL-MK-CPMK']
        ];

        $activeMenu = [
            'l1' => 'transaction',
            'l2' => 'transaction-bobot-cpl-mk-cpmk',
            'l3' => null
        ];
