...
class CplBkMkController extends Controller
{
    public function __construct(){
        $this->menuCode  = 'TRANSACTION.CPLBKMK';
        $this->menuUrl   = url('transaction/cplbkmk');     // set URL untuk menu ini
        $this->menuTitle = 'CPL-BK-MK';                       // set nama menu
        $this->viewPath  = 'Transactional.CplBkMk.';         // untuk menunjukkan direktori view. Diakhiri dengan tanda titik
    }
    ...
    public function index(){
        ...
        $breadcrumb = [
            ...
            'list'  => ['Data Transaction', 'CPL-BK-MK']
        ];

        $activeMenu = [
            'l1' => 'transaction',
            'l2' => 'transaction-cpl-bk-mk',
            'l3' => null
        ];
