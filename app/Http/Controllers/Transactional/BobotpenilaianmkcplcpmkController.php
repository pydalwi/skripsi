...
use App\Models\Transactional\BobotpenilaianmkcplcpmkModel;
use Yajra\DataTables\Facades\DataTables;
use Illuminate\Support\Facades\Validator;
class BobotpenilaianmkcplcpmkController extends Controller
{
    public function __construct(){
        $this->menuCode  = 'TRANSACTION.BOBOTPENILAIANMK';
        $this->menuUrl   = url('transaction/bobotpenilaimk');     // set URL untuk menu ini
        $this->menuTitle = 'Bobot Penilaian MK-CPL-CPMK';                       // set nama menu
        $this->viewPath  = 'Transactional.Bobotpenilaianmkcplcpmk.';         // untuk menunjukkan direktori view. Diakhiri dengan tanda titik
    }
    ...
    public function index(){
        ...
        $breadcrumb = [
            ...
            'list'  => ['Data Transaction', 'Bobot Penilaian MK-CPL-CPMK']
        ];

        $activeMenu = [
            'l1' => 'transaction',
            'l2' => 'transaction-bobot-mk-cpl-cpmk',
            'l3' => null
        ];
